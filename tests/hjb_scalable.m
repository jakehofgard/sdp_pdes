...
mset(sdpsettings( ...
    ...
    'showprogress', 1, ...
    'debug', 1, ...
    'scs.alpha', 1.5, ... % DR relaxation. Default value is 1.5, recommended between 1-2.
    'scs.rho_x', 1e-6, ... % Primal scale factor. Default value is 1e-3.
    'scs.scale', 5.0, ... % Dual scale factor. YALMIP Default factor is 5.0. 
    'scs.gpu', 1) ... % Use GPU acceleration for SCS.
);
